                    ...
                    <div class="mb-3">
                        <select class="form-select" name="payment_method" aria-label="Default select example">
                            ...
                            <option value="paytr">
                                ...
                                '.Cache::get('paytr_extra_commission').'%'.' Commission' }} @endif
                            </option>
                            @endif
                            ...
                            <option value="stripe">
                                ...
                                '.Cache::get('stripe_extra_commission') .'%'.' Commission' }} @endif</option>
                            @endif
                            @if (Cache::get('shopier_active') == 1)
                            <option value="shopier">
                                {{Cache::get('shopier_name')}}
                                @if(Cache::get('shopier_extra_commission')) {{ ' +
                                '.Cache::get('shopier_extra_commission') .'%'.' Commission' }} @endif
                            </option>
                            @endif
